...
<div class="bg-white rounded-lg shadow-md overflow-visible transform hover:scale-105 transition-transform duration-500">
    ...
    <div class="p-6">
        ...
        <a href="{{route('services.show', $link)}}" class="text-primary hover:text-gray-600 font-bold transition duration-300 group">
            Saber más 
