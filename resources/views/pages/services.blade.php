<x-layout.app>
    <section class="pt-24 pb-16 md:pt-32 md:pb-24 text-white relative" style="background-image: url('{{asset($servicios['image'])}}'); background-size: cover; background-position: center;">
        ...
        <div class="container mx-auto px-4 py-4 relative z-9 flex items-center h-full">
            <div class="text-start" data-aos="fade-up" data-aos-duration="800">
                <h1 class="text-4xl md:text-5xl font-bold mb-4">{{$servicios['title']}}</h1>
            </div>
        </div>
    </section>
    ...
    <section class="py-12 bg-gray-100">
        <div class="container mx-auto px-4">
            <p class="text-gray-700 text-justify text-lg mb-3">{{ $servicios['description_first'] }}</p>
            <p class="text-gray-700 text-justify text-lg">{{ $servicios['description_second'] }}</p>
